...
const petailFormReducer = (state: PetailForm[], action: { type: string; payload?: any }) => {
    switch (action.type) {
        case 'INSE':
...
const PetailFormsStore = createContext<[PetailForm[], React.Dispatch<{ type: string; payload?: any }>]>([[], () => {}]);
